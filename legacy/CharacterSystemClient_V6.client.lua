-- ============================================
-- CHARACTER SYSTEM CLIENT V6 — SEM ABA GRÁTIS (CATÁLOGO 100% DINÂMICO)
-- Coloque em StarterPlayer > StarterPlayerScripts
-- Nome: "CharacterSystemClient"
-- SUBSTITUI: CharacterSystemClient V5 (ou V4, se o V5 não foi instalado)
-- REMOVER:   CharacterSystemClient V5 / CharacterSystemClient V4
-- ============================================
-- (V6) ALTERAÇÕES:
...
print("[CHAR SYSTEM V6] Inicializando sistema 100% catálogo (sem aba Grátis)...")
...
if not getCatalogCharactersRemote then
	warn("[CHAR SYSTEM V6] GetCatalogCharacters não encontrado — o CharacterCatalogServer_V4 está no ServerScriptService?")
end
...
local function createAbilitiesPopup(characterName)
	...
	descFrame.Size = UDim2.new(0.96, 0, 0.65, 0)
	descFrame.Position = UDim2.new(0.02, 0, 0.31, 0)
...
task.spawn(function()
	...
	if _G.RegisterMenuCategory then
		...
		print("[CHAR SYSTEM V6] Registrado no Menu Unificado: LOJA + INVENTÁRIO")
	end
end)

print([[
╔══════════════════════════════════════════════════════╗
║  CHARACTER SYSTEM CLIENT V6 — CARREGADO             ║
╠══════════════════════════════════════════════════════╣
